    ...
    window.Alpine.data("ToastComponent", function ($wire) {
      return {
          ...
          window.Toast = {
            ...
            debug: function debug(message) {
              var title = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : "",
                duration = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : void 0;
              this.component.add(this.make(message, title, "debug", null != duration ? duration : this.component.defaultDuration));
            },
            info: function info(message) {
              var title = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : "",
                duration = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : void 0;
              this.component.add(this.make(message, title, "info", null != duration ? duration : this.component.defaultDuration));
            },
            success: function success(message) {
              var title = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : "",
                duration = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : void 0;
              this.component.add(this.make(message, title, "success", null != duration ? duration : this.component.defaultDuration));
            },
            warning: function warning(message) {
              var title = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : "",
                duration = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : void 0;
              this.component.add(this.make(message, title, "warning", null != duration ? duration : this.component.defaultDuration));
            },
            danger: function danger(message) {
              var title = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : "",
                duration = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : void 0;
              this.component.add(this.make(message, title, "danger", null != duration ? duration : this.component.defaultDuration));
            }
        ...
        scheduleRemoval: function scheduleRemoval(toastIndex) {
          var _this3 = this;
          Object.keys(this.pendingRemovals).includes(toastIndex.toString()) || 0 !== this.toasts[toastIndex].duration && (this.pendingRemovals[toastIndex] = setTimeout(function () {
            _this3.remove(toastIndex);
          }, this.toasts[toastIndex].duration));
        },
        scheduleRemovalWithOlder: function scheduleRemovalWithOlder() {
          for (var toastIndex = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : this.count, i = 0; i < toastIndex; i++) this.scheduleRemoval(i);
        },
        cancelRemovalWithNewer: function cancelRemovalWithNewer(toastIndex) {
          for (var i = this.count - 1; i >= toastIndex; i--) clearTimeout(this.pendingRemovals[i]), delete this.pendingRemovals[i];
        },
